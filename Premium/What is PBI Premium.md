Power BI Premium is a capacity based license for PBI consumers.  There are a number of features that come with Premium but the ability to create new reports remains a Pro license feature.
